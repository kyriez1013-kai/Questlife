...
function getV11FixtureRoute(): 'stage0' | 'stage1' | 'stage2-rebaseline' | 'stage2-controls' | 'universal-capture' | null {
  ...
  if (v11FixtureRoute) {
    return (
      <SafeAreaProvider>
        ...
        {v11FixtureRoute === 'universal-capture'
          ? <UniversalCaptureFixtureScreen />
