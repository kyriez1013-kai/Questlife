...
const evidence: DecisionEvidencePacketV1 = {
  ...
  availableLevels: ['A', 'B', 'D'],
  highestEvidenceLevel: 'D',
  items: [
    { id: 'fact', category: 'fact', evidenceLevel: 'A', labelKey: 'fact', sourceIds: ['state-1'] },
    { id: 'reference', category: 'personal_comparison', evidenceLevel: 'B', labelKey: 'reference', sourceIds: ['ref-1'] },
    { id: 'joint', category: 'joint_evidence', evidenceLevel: 'D', labelKey: 'joint', sourceIds: ['joint-1'], supportCount: 7, counterexampleCount: 3 },
  ],
  similarPeriods: [],
  scenarioBranches: [],
  missingness: [],
