...
const styles = StyleSheet.create({
  ...
  dateTitle: { color: theme.text, fontSize: 18, fontWeight: '800', marginTop: 22, marginBottom: 10 },
  ...
  hourRow: { flexDirection: 'row', minHeight: 44, borderBottomWidth: 1, borderBottomColor: theme.border },
  hourLabel: { width: 58, color: theme.textDim, fontSize: 12, fontWeight: '800', paddingTop: 9, textAlign: 'center' },
  ...
  weekDay: { width: '31.8%', minHeight: 116, backgroundColor: theme.card, borderRadius: theme.radius.lg, padding: 12, borderWidth: 1, borderColor: theme.border },
  ...
  placeholderCard: { marginTop: 18, backgroundColor: theme.card, borderRadius: theme.radius.lg, padding: 20, borderWidth: 1, borderColor: theme.border, ...theme.shadow },
